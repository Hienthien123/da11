...
@Component({
  selector: 'app-trang-thai-form',
  templateUrl: './trang-thai-form.component.html',
  styleUrls: ['./trang-thai-form.component.css']
})
export class TrangThaiFormComponent implements OnInit {
